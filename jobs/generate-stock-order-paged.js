...
var runMe = function(connectionInfo, userId, reportId, outletId, resolvedSupplierName, pageNumber, pageSize){
  ...
  return vendSdk.products.fetch(args, connectionInfo)
    ...
    .then(function(products) {
      ...
      if (products && _.isObject(products) && !_.isArray(products)) {
        console.log(commandName + ' > 1st tap block > extract products array from object');
